...
<html lang="ko">
    <head>
        ...
        <meta property="og:url" content="https://cartoonaf.touchizen.com/<?php echo $serviceUri; ?>" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="사진 카툰화와 동물상 테스트" />
        <meta property="og:description" content="사진을 카툰으로 만들기와 얼굴로 보는 인공지능 동물상 테스트, 나와 닮은 카툰과 동물상을 찾아보세요! 대표 동물상 연예인 사진 데이터로 학습한 인공지능이 나의 얼굴로 동물상과 특징을 찾아드립니다. 회원가입도 필요없이 화면에서 바로 확인해보세요! 사진 데이터는 그 어디에도 전송되지 않습니다. 추가적으로 인공지능이 보는 나의 동물상 테스트 한번 해볼 수 있습니다.! "/>
